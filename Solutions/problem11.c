...
unsigned long long problem11()
{
    ...
    {
        for (unsigned long long j = 0; j < degree - 3; j++)
        {
            unsigned long long horizontal = grid[i][j] * grid[i][j + 1] * grid[i][j + 2] * grid[i][j + 3];

            unsigned long long vertical = grid[j][i] * grid[j + 1][i] * grid[j + 2][i] * grid[j + 3][i];

            unsigned long long diagonal1 = grid[i][j] * grid[i + 1][j + 1] * grid[i + 2][j + 2] * grid[i + 3][j + 3];
